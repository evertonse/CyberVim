local options = {
  ...
  timeoutlen      = 120,                        -- time to wait for a mapped sequence to complete (in milliseconds)
  ...
  sidescrolloff   = 12,                       -- minimal number of screen columns either side of cursor if wrap is `false`
